...
var Grid = (function() {
	...
	function initEvents() {
		...
		$items.on( 'click', 'span.portfolio-item-close', function() {
			hidePreview();
			return false;
	...
	Preview.prototype = {
		...
		update : function( $item ) {
			...
			if( current !== -1 ) {
				...
				$currentItem.removeClass( 'portfolio-item-expanded' );
				this.$item.addClass( 'portfolio-item-expanded' );
		...
		close : function() {
			...
			var self = this,
				onEndFn = function() {
					...
					self.$item.removeClass( 'portfolio-item-expanded' );
		...
		setHeights : function() {
			...
			var self = this,
				onEndFn = function() {
					...
					self.$item.addClass( 'portfolio-item-expanded' );
				};
